...
func (d *createData) ExecContext(ctx context.Context) (sql.Result, error) {
	if d.RunWith == nil {
...
func (d *createData) QueryContext(ctx context.Context) (*sql.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *createData) QueryRowContext(ctx context.Context) RowScanner {
	if d.RunWith == nil {
...
// ExecContext builds and ExecContexts the query with the Runner set by RunWith.
func (b CreateBuilder) ExecContext(ctx context.Context) (sql.Result, error) {
	data := builder.GetStruct(b).(createData)
	return data.ExecContext(ctx)
}

// QueryContext builds and QueryContexts the query with the Runner set by RunWith.
func (b CreateBuilder) QueryContext(ctx context.Context) (*sql.Rows, error) {
	data := builder.GetStruct(b).(createData)
	return data.QueryContext(ctx)
}

// QueryRowContext builds and QueryRowContexts the query with the Runner set by RunWith.
func (b CreateBuilder) QueryRowContext(ctx context.Context) RowScanner {
	data := builder.GetStruct(b).(createData)
	return data.QueryRowContext(ctx)
}

// ScanContext is a shortcut for QueryRowContext().Scan.
func (b CreateBuilder) ScanContext(ctx context.Context, dest ...interface{}) error {
